...
{
	char *packed = 0;
	nvlist_pack(nvl, &packed, sizep, NV_ENCODE_NATIVE, 0);
	return (packed);
}
...
{
	(nvlist_add_uint16_array(nvl, name, val, n));
}

void
fnvlist_add_int32_array(nvlist_t *nvl, const char *name, int32_t *val, uint_t n)
{
	(nvlist_add_int32_array(nvl, name, val, n));
}
...
{
	(nvlist_add_uint32_array(nvl, name, val, n));
}

void
fnvlist_add_int64_array(nvlist_t *nvl, const char *name, int64_t *val, uint_t n)
{
	(nvlist_add_int64_array(nvl, name, val, n));
}
...
{
	(nvlist_add_uint64_array(nvl, name, val, n));
}
...
{
	(nvlist_add_string_array(nvl, name, val, n));
}
...
{
	(nvlist_add_nvlist_array(nvl, name, val, n));
}

void
fnvlist_remove(nvlist_t *nvl, const char *name)
{
	(nvlist_remove_all(nvl, name));
}

void
fnvlist_remove_nvpair(nvlist_t *nvl, nvpair_t *pair)
{
	(nvlist_remove_nvpair(nvl, pair));
}
...
{
	nvpair_t *rv;
	(nvlist_lookup_nvpair(nvl, name, &rv));
	return (rv);
}
...
{
	boolean_t rv;
	(nvlist_lookup_boolean_value(nvl, name, &rv));
	return (rv);
}
...
{
	uchar_t rv;
	(nvlist_lookup_byte(nvl, name, &rv));
	return (rv);
}
...
{
	int8_t rv;
	(nvlist_lookup_int8(nvl, name, &rv));
	return (rv);
}
...
{
	int16_t rv;
	(nvlist_lookup_int16(nvl, name, &rv));
	return (rv);
}
...
{
	int32_t rv;
	(nvlist_lookup_int32(nvl, name, &rv));
	return (rv);
}
...
{
	int64_t rv;
	(nvlist_lookup_int64(nvl, name, &rv));
	return (rv);
}
...
{
	uint8_t rv;
	(nvlist_lookup_uint8(nvl, name, &rv));
	return (rv);
}
...
{
	uint16_t rv;
	(nvlist_lookup_uint16(nvl, name, &rv));
	return (rv);
}
...
{
	uint32_t rv;
	(nvlist_lookup_uint32(nvl, name, &rv));
	return (rv);
}
...
{
	uint64_t rv;
	(nvlist_lookup_uint64(nvl, name, &rv));
	return (rv);
}
...
{
	boolean_t *rv;
	(nvlist_lookup_boolean_array(nvl, name, &rv, n));
	return (rv);
}
...
{
	uchar_t *rv;
	(nvlist_lookup_byte_array(nvl, name, &rv, n));
	return (rv);
}
...
{
	int8_t *rv;
	(nvlist_lookup_int8_array(nvl, name, &rv, n));
	return (rv);
}
...
{
	uint8_t *rv;
	(nvlist_lookup_uint8_array(nvl, name, &rv, n));
	return (rv);
}
...
{
	int16_t *rv;
	(nvlist_lookup_int16_array(nvl, name, &rv, n));
	return (rv);
}
...
{
	uint16_t *rv;
	(nvlist_lookup_uint16_array(nvl, name, &rv, n));
	return (rv);
}
...
{
	int32_t *rv;
	(nvlist_lookup_int32_array(nvl, name, &rv, n));
	return (rv);
}
...
{
	uint32_t *rv;
	(nvlist_lookup_uint32_array(nvl, name, &rv, n));
	return (rv);
}
...
{
	int64_t *rv;
	(nvlist_lookup_int64_array(nvl, name, &rv, n));
	return (rv);
}
...
{
	uint64_t *rv;
	(nvlist_lookup_uint64_array(nvl, name, &rv, n));
	return (rv);
}
...
{
	boolean_t rv;
	(nvpair_value_boolean_value(nvp, &rv));
	return (rv);
}
